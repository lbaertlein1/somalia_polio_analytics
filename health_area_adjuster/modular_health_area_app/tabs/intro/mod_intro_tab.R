      ...
      div(
        ...
        .intro_section('How it works',
                       div(
                         ...
                         .intro_step('2', 'Orient yourselves',
                                     paste0('Familiarise the group with the district on the map. Drop optional landmark pins ',
                                            'to mark roads, boundaries, or reference points that will help with later steps.')),
